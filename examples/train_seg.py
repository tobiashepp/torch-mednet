...
parser.add_argument('-c', '--config', is_config_file=True, default="/mnt/share/raheppt1/data/vessel/config/aorth_seg.yaml")
...
parser = SegmentationNet.add_model_specific_args(parser)
...
logging.getLogger().setLevel(hparams.log_level)
